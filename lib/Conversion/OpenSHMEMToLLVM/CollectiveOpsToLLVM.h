...
#ifndef MLIR_LIB_CONVERSION_OPENSHMEMTOLLVM_COLLECTIVEOPSTOLLVM_H
#define MLIR_LIB_CONVERSION_OPENSHMEMTOLLVM_COLLECTIVEOPSTOLLVM_H
...
/// Populate conversion patterns for OpenSHMEM Collective operations.
